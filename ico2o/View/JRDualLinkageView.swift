...
class JRDualLinkageView: UIView {
    ...
    let widthOfEachLevelOnLeft: Float = 120
...
extension JRDualLinkageView {
    func reloadData() {
        ...
        if self.delegate != nil {
            if self.delegate!.respondsToSelector(#selector(JRDualLinkageViewDelegate.widthOfFirstLevel(_:))) {
...
extension JRDualLinkageView: UITableViewDataSource {
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        if tableView === self.firstLevelTableView {
            if self.delegate!.respondsToSelector(#selector(JRDualLinkageViewDelegate.linkageView(_:tableView:cellForRowAtIndexInFirstLevel:))) {
            ...
            if self.delegate!.respondsToSelector(#selector(JRDualLinkageViewDelegate.linkageView(_:tableView:index:cellForRowAtIndexPathInSecondLevel:))) {
    ...
    func tableView(tableView: UITableView, titleForHeaderInSection section: Int) -> String? {
        if tableView === self.secondLevelTableView {
            if self.dataSource!.respondsToSelector(#selector(JRDualLinkageViewDataSource.linkageView(_:index:titleForHeaderInSectionInSecondLevel:))) {
...
extension  JRDualLinkageView: UITableViewDelegate {
    func tableView(tableView: UITableView, heightForHeaderInSection section: Int) -> CGFloat {
        ...
        if tableView === self.secondLevelTableView {
            if self.delegate!.respondsToSelector(#selector(JRDualLinkageViewDelegate.linkageView(_:index:heightForHeaderInSectionInSecondLevel:))) {
    ...
    func tableView(tableView: UITableView, heightForRowAtIndexPath indexPath: NSIndexPath) -> CGFloat {
        ...
        if tableView === self.firstLevelTableView {
            if self.delegate!.respondsToSelector(#selector(JRDualLinkageViewDelegate.linkageView(_:heightForRowsAtIndexInFirstLevel:))) {
                return CGFloat(self.delegate!.linkageView!(self, heightForRowsAtIndexInFirstLevel: indexPath.row))
            } else {
                return CGFloat(self.heightOfRowsDefault)
            }
        } else if tableView === self.secondLevelTableView {
            if self.delegate!.respondsToSelector(#selector(JRDualLinkageViewDelegate.linkageView(_:index:heightForRowsAtIndexPathInSecondLevel:))) {
    ...
    func tableView(tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        if tableView === self.secondLevelTableView {
            if self.delegate!.respondsToSelector(#selector(JRDualLinkageViewDelegate.linkageView(_:index:viewForHeaderInSectionInSecondLevel:))) {
    ...
    func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        if tableView === self.firstLevelTableView {
            ...
            if self.delegate != nil {
                if self.delegate!.respondsToSelector(#selector(JRDualLinkageViewDelegate.linkageView(_:index:didSelectRowAtIndexPathInSecondLevel:))) {
