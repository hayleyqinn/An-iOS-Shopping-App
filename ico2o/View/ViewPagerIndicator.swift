...
public class ViewPagerIndicator: UIControl {
    ...
    @IBInspectable public var indicatorHeight: CGFloat = 5.0
    ...
    func addButtons(){
        for i in 0 ..< titles.count {
            let button = UIButton()
            button.addTarget(self, action: #selector(ViewPagerIndicator.didSelectedButton(_:)), forControlEvents: .TouchUpInside)
